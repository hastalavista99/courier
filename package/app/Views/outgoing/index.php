          ...
          <tbody>
            <?php if (!empty($packages)) {  ?>
              <?php foreach ($packages as $package) : ?>
                ...
                <tr>
                  <td class="text-center"><a href="<?= site_url('packages/outview?pid=' . $package['id'] . '&origin=' . $package['origin_name'] . '&destination=' . $package['destination_name']) ?>"><?= esc($package['unique_id']) ?></a></td>
